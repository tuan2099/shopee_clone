...
function NavHeader() {
  ...
  const currentLanguage = locales[i18n.language as keyof typeof locales] // lấy ngôn ngữ hiện tại
        ...
        {isAuthenticated && (
          <Popover
            ...
            renderPopover={
              <div className='relative rounded-sm border border-gray-200 bg-white shadow-md'>
                <div className='flex flex-col py-2 px-3'>
                  <Link to='/user/profile' className='block py-2 px-3 hover:text-orange'>
                    Tài khoản của tôi
                  </Link>
                  <Link to='/user/purchase' className='block py-2 px-3 hover:text-orange'>
                    Đơn mua
                  </Link>
